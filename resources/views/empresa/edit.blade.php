...
@section('content')
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="Cnpj" name="Cnpj" value="{{$editar_empresa->Cnpj}}" required>
    </div>
    <div class="col-md-4 mb-3">
  ...
  <div class="form-row">
    <div class="col-md-3 mb-3">
      ...
      <input type="text" class="form-control" id="Telefone" name="Telefone" value="{{$editar_empresa->Telefone}}" required>
    </div>
    ...
    <div class="col-md-3 mb-3">
      ...
      <input type="text" class="form-control" id="Estado" name="Estado" value="{{$editar_empresa->Estado}}" required>
    </div>
    <div class="col-md-3 mb-3">
